...
void VRISC_V_Processor_Pipelined___024root___eval_triggers__act(VRISC_V_Processor_Pipelined___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    VRISC_V_Processor_Pipelined___024root___eval_triggers__act\n"); );
    // Body
    ...
    vlSelf->__VactTriggered.set(4U, (((IData)(vlSelf->clk) 
                                     ...
                                     | ((IData)(vlSelf->reset) 
                                        != (IData)(vlSelf->__Vtrigprevexpr___TOP__reset__0))));
    vlSelf->__VactTriggered.set(5U, (vlSelf->RISC_V_Processor_Pipelined__DOT__PC_Out 
                                     != vlSelf->__Vtrigprevexpr___TOP__RISC_V_Processor_Pipelined__DOT__PC_Out__0));
...
VL_INLINE_OPT void VRISC_V_Processor_Pipelined___024root___act_sequent__TOP__2(VRISC_V_Processor_Pipelined___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VRISC_V_Processor_Pipelined__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VRISC_V_Processor_Pipelined___024root___act_sequent__TOP__2\n"); );
    // Body
    if (((IData)(vlSelf->reset) | (IData)(vlSelf->RISC_V_Processor_Pipelined__DOT__pc__DOT__reset_force))) {
        vlSelf->RISC_V_Processor_Pipelined__DOT__PC_Out = 0ULL;
        vlSelf->__Vdly__RISC_V_Processor_Pipelined__DOT__pc__DOT__reset_force = 0U;
    } else {
        vlSelf->RISC_V_Processor_Pipelined__DOT__PC_Out 
...
VL_INLINE_OPT void VRISC_V_Processor_Pipelined___024root___nba_sequent__TOP__1(VRISC_V_Processor_Pipelined___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VRISC_V_Processor_Pipelined__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VRISC_V_Processor_Pipelined___024root___nba_sequent__TOP__1\n"); );
    // Body
    vlSymsp->TOP____024unit.__VmonitorNum = 1U;
}

VL_INLINE_OPT void VRISC_V_Processor_Pipelined___024root___nba_comb__TOP__1(VRISC_V_Processor_Pipelined___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VRISC_V_Processor_Pipelined__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VRISC_V_Processor_Pipelined___024root___nba_comb__TOP__1\n"); );
    // Body
    if (VL_UNLIKELY(((~ (IData)(vlSymsp->TOP____024unit.__VmonitorOff)) 
                     & (1U == vlSymsp->TOP____024unit.__VmonitorNum)))) {
        VL_WRITEF("PC_In = %20#, PC_Out = %20#, Instruction = %b, Opcode = %b, Funct3 = %b, rs1 = %2#, rs2 = %2#, rd = %2#, funct7 = %b, ALUOp = %b, imm_data = %20#, Operation = %b\n",
