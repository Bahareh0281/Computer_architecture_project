...
VL_ATTR_COLD void VRISC_V_processor___024unit___ctor_var_reset(VRISC_V_processor___024unit* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VRISC_V_processor__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+  VRISC_V_processor___024unit___ctor_var_reset\n"); );
    // Body
